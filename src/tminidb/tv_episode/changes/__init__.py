...
from tminidb.tv_episode.changes.models import TvEpisodeChangesModel, model_validate_json
...
class TvEpisodeChanges(BaseChanges[TvEpisodeChangesModel]):
    ...
    TV episode changes are a little different than movie changes in that there are some
