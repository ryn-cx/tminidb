...
# TODO: Validate
def generate_tv_episode(client: TMiniDB) -> None:
    """Rebuild TvEpisodeModel."""
    for series_id, season_number, episode_number in EPISODES:
        download_if_missing(
            ...
            lambda episode=(series_id, season_number, episode_number): (
                client.tv_episode.download(*episode)
            ),
        )

    generate_model(FILES_PATH, TMINIDB_PATH, "TvEpisodeModel")
